...
ALTER TABLE permission ADD COLUMN deleted TINYINT(1) DEFAULT 0;
...
UPDATE user SET password='$2a$10$WuekERlTzw4On2s1uGRl8OVjvXj47n20PoEaTdhY/.Opw/vENRTd2' WHERE  username = 'admin';
