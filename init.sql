...
INSERT INTO `permission` (`id`, `permission_code`, `permission_name`, `parent_id`, `sort`) VALUES
(1, 'user:list', '查询用户列表', 0, 1),
(2, 'user:add', '新增用户', 0, 2),
(3, 'user:edit', '编辑用户', 0, 3),
(4, 'user:delete', '删除用户', 0, 4),
(5, 'role:list', '查询角色列表', 0, 5),
(6, 'role:add', '新增角色', 0, 6),
(7, 'role:edit', '编辑角色', 0, 7),
(8, 'role:delete', '删除角色', 0, 8),
(9, 'log:list', '查询日志列表', 0, 9),
(10, 'log:export', '导出日志', 0, 10)
...
(1, 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EfMlqYy7JkI3q5q5q5q5q', '管理员', 1),
(2, 'user', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EfMlqYy7JkI3q5q5q5q5q', '普通用户', 1)
